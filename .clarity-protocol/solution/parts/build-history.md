...
**The record of how Tephra got to 1.0**, phase by phase, kept because the
*reasoning* is the reusable part: what each slice taught, what it moved, and
which of its predictions were wrong. The live plan is `../milestones.md`; this
is behind it.

**Lifted out of `../milestones.md` on 2026-09-16**, when that file stopped being
a checklist and became the list of projects worth choosing between. Nothing here
was rewritten in the move — the dates, the strikethroughs and the amendments are
as they were recorded at the time, which is the only thing that makes a build
record worth keeping.

**Milestones were *slices*, not feature groups.** Each one was a path through W,
X and Z that worked end to end, because a layer built alone is a layer whose
interface has never been tested. That rule held for the whole of v1 and is
visible in every phase below.
...
**Design: `solution/parts/day-boundary.md`. Decisions: D62, D63, amending D38.**
...
**Roadmap: `solution/parts/todo-roadmap.md`. Design: `goal/todo.md`,
`solution/parts/todo.md`. Decisions: D55–D59.**
...
**Roadmap: `solution/parts/link-roadmap.md`. Requirement: R10a. Decisions: D57, D60,
D61.**
...
**Roadmap: `solution/parts/search-roadmap.md`. Requirement: R10. Decisions: D9 (as
amended), D65, D66.**
...
- Image paste writing a file and inserting a link (R7) — **done**; here by
  schedule, not by kinship, and written up in `solution/parts/image-notes.md`. It
...
- **The keymap and the visual system: backlog**, grouped — see below. The
  keymap's *inventory* is done (`solution/parts/keymap.md`); its design is not.
...
**Roadmap: `solution/parts/horizon-roadmap.md`. Design: `solution/parts/horizon.md`.
