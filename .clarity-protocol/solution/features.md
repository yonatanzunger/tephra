...
| Right-to-left text reads the way it is written | D98 | ✓ v1 — `dir="auto"` per line, `perLineTextDirection`, alignment to `start`; the prose editor only, the plain-HTML surfaces still to sweep |
